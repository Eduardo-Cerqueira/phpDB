...
if (!isset($_POST['email'], $_POST['fullname'], $_POST['password'], $_POST['cpassword'])) {
	set_errors('Pas de formulaire recu', '/admin_register.php');
}

if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) {
	set_errors('Email invalide', '/admin_register.php');
}

if (empty($_POST['fullname']) || strlen($_POST['fullname']) > 100) {
	set_errors('Fullname invalide', '/admin_register.php');
}

if (empty($_POST['password']) || ($_POST['password'] !== $_POST['cpassword'])) {
	set_errors('Message invalide', '/admin_register.php');
}
